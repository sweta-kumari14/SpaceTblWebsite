<%@ Page Title="" Language="C#" MasterPageFile="~/master-tbl.master" AutoEventWireup="true" CodeFile="Copy of tbl-coworking.aspx.cs" Inherits="tbl_coworking" %>
        ...
        <section class="section section-no-background section-height-1 border-0 pb-5 m-0 appear-animation" data-appear-animation="fadeIn">
            <div class="container">
                 ...
                 <div class="row">
                        ...
                        <div class="tabs tabs-bottom tabs-center tabs-simple">
                            <ul class="nav nav-tabs">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#tabsNavigationSimple1" data-toggle="tab">PUNE</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigationSimple2" data-toggle="tab">RANCHI</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigationSimple3" data-toggle="tab">DELHI</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigationSimple4" data-toggle="tab">BANGALORE</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigationSimple5" data-toggle="tab">INDORE</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigationSimple6" data-toggle="tab">RAIPUR</a>
                                </li>
                            </ul>
                        ...
                        <article>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a href="#" class="text-decoration-none"  data-toggle="modal" data-target="#defaultModal">
                                        <img src="img/tbl-coworking/coworking-3.jpg" class="img-fluid hover-effect-2 mb-3" data-toggle="modal" data-target="#defaultModal" alt="" />
                                    </a>
                                        </>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-2 mb-1"  >LOCATION 1</p>
                    ...
                    <div class="col-sm-8 col-md-4 mb-4 mb-md-0">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-uppercase text-2 mb-1">LOCATION 2</p>
                                <!--    <h4 class="line-height-5 ls-0"><strong>₹9999/month</strong><br />
                                        [Allowed to use for our existing customers]</h4>-->
                                    
                                    <%--<a class="btn btn-outline btn-rounded btn-primary text-uppercase btn-with-arrow mb-5 mb-lg-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1100" href="#" data-toggle="modal" data-target="#formModal2">BOOK CO-WORKING SPACE<span><i class="fas fa-chevron-right"></i></span></a>--%>
                                </div>
                            </div>
                        </article>
                    </div>
                    <div class="col-sm-8 col-md-4">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-2 mb-1">LOCATION 3</p>
                    ...
                    <div class="col-sm-8 col-md-4 mb-4 mb-md-0 py-4">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-2 mb-1">LOCATION 4</p>
                    ...
                    <div class="col-sm-8 col-md-4 mb-4 mb-md-0 py-4">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-uppercase text-2 mb-1">LOCATION 5</p>
                                  <!--  <h4 class="line-height-5 ls-0"><strong>₹9999/month</strong><br />
                                        You may also contact us & discuss.</h4>-->
                                    ...
                                    <a class="btn btn-outline btn-rounded btn-primary text-uppercase btn-with-arrow mb-5 mb-lg-2 appear-animation" data-appear-animation="fadeInRightShorter"
                                        data-appear-animation-delay="1100" href="#" data-toggle="modal" data-target="#formModal2">BOOK CO-WORKING SPACE <span><i class="fas fa-chevron-right"></i></span></a>
                                    </div>
                                    </div>
                        </article>
                    </div>
               <!--     <div class="col-sm-8 col-md-4 py-4">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a href="img/tbl-coworking/coworking-6.jpg" class="img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon">
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-2 mb-1"  data-toggle="modal" data-target="#defaultModal" >MEETING SPACE</p>
                                    <h4 class="line-height-5 ls-0">Please contact us & share your requirement.</h4>
                      ...
                      <div class="row justify-content-center recent-posts appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="2000">
                      <div class="col-sm-8 col-md-4 mb-4 mb-md-0 py-4">
                        <article>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-2 mb-1">LOCATION 1</p>
                                   <h4 class="line-height-5 ls-0"><strong>MAHAVIR TOWER RANCHI</strong><br/>
                                        You may also contact us & discuss.</h4>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="col-sm-8 col-md-4 mb-4 mb-md-0 py-4">
                        <article>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p class="text-color-primary text-uppercase text-2 mb-1">LOCATION 2</p>
                                  <h4 class="line-height-5 ls-0"><strong>ASHOK NAGAR RANCHI</strong><br />
                                        You may also contact us & discuss.</h4>
                                    <a class="btn btn-outline btn-rounded btn-primary text-uppercase btn-with-arrow mb-5 mb-lg-2 appear-animation" data-appear-animation="fadeInRightShorter"
                                        data-appear-animation-delay="1100" href="#" data-toggle="modal" data-target="#formModal2">BOOK CO-WORKING SPACE <span><i class="fas fa-chevron-right"></i></span></a>
                                 </div>
